...
@root.command()
@click.option("--host", "-s", default="localhost", help="host interface to bind to")
@click.option("--port", "-p", default="8086", help="service port")
@click.option(
    "--threaded/--no-threaded",
    default=True,
    help="Whether to thread request handling or not",
)
@click.option("--debug/--no-debug", default=False, help="Toggle flask debugging")
@click.option("--config", "-c", default=None, help="Flask configuration file")
@click.pass_obj
...
@root.command()
@click.option("--config", "-c", default=None, help="Flask configuration file")
@click.option("--admin/--no-admin", default=False, help="admin flag setting")
@click.option("--user", "-u", help="User to apply flag setting to")
@click.pass_obj
...
@click.option("--config", "-c", default=None, help="Flask configuration file")
@click.option(
    "--verify/--no-verify", default=False, help="email verification flag setting"
)
@click.option("--user", "-u", help="User to apply flag setting to")
@click.pass_obj
...
@root.command()
@click.option("--config", "-c", default=None, help="Flask configuration file")
@click.option("--hashtag", "-h", default=None, help="Only show posts with this hashtag")
@click.pass_obj
